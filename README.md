...
インストーラ版とポータブル版は、週に 1 回 GitHub に最新版の番号を問い合わせ、新しい版があれば
「ダウンロードページを開きますか？」と知らせます。自動でダウンロードや入れ替えはしません。
設定画面の **情報** タブで止めたり、今すぐ確認したりできます。
Microsoft Store 版はストアが更新するので、この確認はしません。winget で入れた場合は `winget upgrade smarciva.smarcivaZIP` でも更新できます。
...
通信は一切行わず、個人情報も集めません。詳しくは [PRIVACY.md](PRIVACY.md) を参照してください。
